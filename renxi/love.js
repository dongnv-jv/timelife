(function(window){
    ...
    Heart = function() {
        ...
        for (var i = 0; i < 2*Math.PI; i += 0.1) {
            ...
            t = i ;
            x = 8*((Math.sin(t) + 1)*Math.cos(t)*((9/10)*Math.cos(8*t) + 1) *((1/10) * Math.cos(24*t) + 1) *((1/10)* Math.cos(200*t) + (9/10)));
            y =8*(Math.sin(t)*(Math.sin(t) + 1)* ((9/10)*Math.cos(8*t) + 1) *((1/10) * Math.cos(24*t) + 1) *((1/10)* Math.cos(200*t) + (9/10)));
            // t = i / Math.PI;
